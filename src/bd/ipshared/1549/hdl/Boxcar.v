...
module	Boxcar #(
		...
		parameter	IW=12,		// Input bit-width
				LGMEM=13,	// Size of the memory.
				OW=(IW+LGMEM),	// Output bit-width
		parameter [0:0]	FIXED_NAVG=1'b1, // True if nbr of avgs is fixed
		...
		output	wire 	[(IW-1):0]	o_avg_result 
		// }}}
	);
	...
	assign i_ce = (counter == 99) ? 1'b1 : 1'b0; 
	
	////////////////////ABS Value//////////////////////
	///////////////////////////////////////////////////
	reg [(IW-1):0] internal_sample; 
	always @(posedge i_clk)
	begin
		if (i_sample[(IW-1)] == 1)
		begin
			internal_sample = ~i_sample + 1'b1;
		end else 
		begin
			internal_sample = i_sample;
		end
	end
	///////////////////////////////////////////////////
	...
	assign o_avg_result = o_result>>LGMEM;
endmodule

...
#
# Generated by Vivado on Tue Sep 17 19:37:17 CEST 2019
...
#
#    "/volume1/scratch/mgrujic/EAGLE-2018-full/EAGLE_full_working_project/Hardware/BD/drone.bd"
#    "/volume1/scratch/mgrujic/EAGLE-2018-full/EAGLE_full_working_project/Hardware/BD/hdl/drone_wrapper.v"
#    "/volume1/scratch/mgrujic/EAGLE-2018-full/EAGLE_full_working_project/Hardware/TCL/constraints/ZYBO_Master.xdc"
#
#*****************************************************************************************
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/src/bd/drone.bd"]"\
 "[file normalize "$origin_dir/src/bd/hdl/drone_wrapper.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/bd/drone.bd"
...
set file "$origin_dir/src/bd/hdl/drone_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
if { [version -short] < 2018.0 } {
   set constr "ZYBO_Master_2016.xdc"
} else {
   set constr "ZYBO_Master_2018.xdc"
}
set file "[file normalize "$origin_dir/constraints/$constr"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/constraints/$constr"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/constraints/$constr"]" $obj

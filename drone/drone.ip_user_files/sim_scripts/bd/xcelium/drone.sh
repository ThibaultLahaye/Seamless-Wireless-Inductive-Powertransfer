...
execute()
{
  xrun $xrun_opts \
       ...
       +incdir+"$ref_dir/../../../../../src/bd/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../../src/bd/ipshared/70fd/hdl" \
       +incdir+"../../../../../src/bd/ipshared/ec67/hdl" \
       +incdir+"../../../../../src/bd/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../../src/bd/ipshared/70fd/hdl" \
